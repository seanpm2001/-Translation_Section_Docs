...
The section of the file that shows available translations, so that the file can be read in another language. Also known as the language switcher section.
...
**File version:** `1 (2024, Friday, August 23rd at 10:42 pm PST)`
